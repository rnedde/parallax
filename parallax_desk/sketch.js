...
//preload images
function preload(){
  image1 = loadImage("c4.png");
  image2 = loadImage("c3.png");
  image3 = loadImage("c2.png");
  image4 = loadImage("c1.png");
}
...
function setup(){
  ...
  shape2 = new Shape(width/2, height/2, 0.05, image2, BLEND);//items
...
class Shape {
  ...
  show(){
    fill(100); 
    this.image.resize(width*SCALE,height * SCALE); //resizes image while keeping aspect ratio
