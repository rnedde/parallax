...
function setup(){
  ...
  //creates shapes
  bgShape = new Shape(width/2, height/2, 0, bg, BLEND);
  shape1 = new Shape(width/2, height/2, 0.2, image1, OVERLAY);
  shape2 = new Shape(width/2, height/2, 0.9, image2, EXCLUSION);
  shape3 = new Shape(width/2, height/2, 0.5, image3, ADD);
